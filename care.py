...
SCKEY = "SCT176576TF9UTl5U1WKJ7fPWhf4FK03BO"
...
def BarkPush(info, type):  # CoolPush酷推
    if type == 0:
        api = "https://api.day.app/jczfKrq4ofQmkHmc6R7ZYm/小钱跟你说：Have a nice day!/" + info+'?sound=birdsong'
    if type == 1:
        ...
        while (True):
            ...
            if (time_struct.tm_hour == 13 and time_struct.tm_min == 47 and time_struct.tm_sec == 0):
                ...
                if (time_struct.tm_hour == 23 and time_struct.tm_min == 30 and time_struct.tm_sec == 00):
                    evenin_message = '不早了，还没睡要赶紧睡觉哦~亲亲宝贝（我也要亲亲'
                    BarkPush(evenin_message)
                    time.sleep(1)
